...
<html>
    ...
    <%
        ...
        MultipartRequest mpr = new MultipartRequest(request, application.getRealPath("data"), limit);String s=session.getAttribute("uid").toString();
      ...
      //  String w1=mpr.getOriginalFileName("photo1");
        String x=mpr.getParameter("email");
        int rs=st.executeUpdate("update USERREGISTER set USERPASSWORD='"+t+"',MOBILENO='"+u+"',CITYNAME='"+v+"',EMAILID='"+x+"',IMGNAME='"+w+"' where USERID='"+s+"'");
