...
<% Class.forName("oracle.jdbc.driver.OracleDriver");
   ...
   String uid=rs.getString("USERID");  
    ...
    <form action="uupdaterecord.jsp" enctype="multipart/form-data" method="post">
    <center><br><br><br><br>
    <h1><u>Update User's Detail</u></h1>
    <br><br><br><br>
    <table align="center" border="1">
      <tr><td>User ID</td>
           ...
           <tr><td>Password</td>
               ...
               <tr><td>Email Id</td>
               <td><input type="text" value="<%=rs.getString("EMAILID")%>" name="email" /></td></tr>
               <tr><td>Photo</td>
